...
export async function GET(context: APIContext): Promise<Response> {
	...
	return rss({
		...
		description: siteConfig.subtitle || siteConfig.description || "No description",
		site: context.site ?? "https://eastenwhite.com",
		customData: `<templateTheme>Firefly</templateTheme>
		<templateThemeVersion>${pkg.version}</templateThemeVersion>
		<templateThemeUrl>https://github.com/EastenWhite</templateThemeUrl>
